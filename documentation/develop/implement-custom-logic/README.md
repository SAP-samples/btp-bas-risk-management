...
1. Choose the hamburger icon in the top left corner and choose **View** &rarr; **Explorer** to enable the file explorer.

    <img src="./images/explorer.png" width="40%">

This gives you the possibility to explore the files generated by the low-code application tools.

2. Navigate to **srv** folder and click right to choose **New file** in dropdown. Enter name `service.js`.

    <img src="./images/create_file.png" width="40%">

3. Add the following code to the new file `service.js`:
